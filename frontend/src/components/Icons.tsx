/* Heroicons (outline) — inline SVG icon components */

const cls = (extra = '') => `w-5 h-5 ${extra}`

export const IconDashboard = ({ className = '' }) => (
  <svg className={cls(className)} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6" />
  </svg>
)

export const IconPermits = ({ className = '' }) => (
  <svg className={cls(className)} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
  </svg>
)

export const IconWorkers = ({ className = '' }) => (
  <svg className={cls(className)} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
  </svg>
)

export const IconCompanies = ({ className = '' }) => (
  <svg className={cls(className)} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.8}>
...
export const IconChevronLeft = ({ className = '' }) => (
  <svg className={cls(className)} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const IconCheck = ({ className = '' }) => (
  <svg className={cls(className)} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
